...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <span class="text-muted small ms-2">Read-only — generated by CAO staff</span>
    </div>
</div>
                ...
                @forelse($predictions as $index => $pred)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-sm btn-secondary" data-bs-toggle="modal" data-bs-target="#historyModal" data-farm-record-id="{{ $pred->farm_record_id }}" title="History">
...
<script>
    ...
    // ============================================================
    // LOAD HISTORY MODAL (with script re-execution for chart)
    // ============================================================
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (historyModal) {
            historyModal.addEventListener('show.bs.modal', function (event) {
                ...
                fetch('/farmer/predictions/' + farmRecordId + '/history')
                    .then(response => response.text())
                    .then(html => {
