...
<form id="farmForm" action="{{ route('admin.farms.update', $farm->id) }}" method="POST">
    ...
    <div class="row g-3">
        <div class="col-md-6">
            ...
            <input type="text" name="name" class="form-control" placeholder="e.g., Dela Cruz Rice Field" value="{{ old('name', $farm->name) }}" required>
        </div>

        <div class="col-md-6">
            <label class="form-label fw-semibold">Barangay <span class="text-danger">*</span></label>
            <input type="text" name="barangay" class="form-control" placeholder="e.g., Calaocan" value="{{ old('barangay', $farm->barangay) }}" required>
        </div>

        <div class="col-md-6">
            <label class="form-label fw-semibold">Land Area (ha) <span class="text-danger">*</span></label>
            <input type="number" step="0.01" name="land_area_ha" class="form-control" placeholder="2.50" value="{{ old('land_area_ha', $farm->land_area_ha) }}" required>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="row g-2">
                <div class="col-6">
                    <input type="number" step="0.00000001" name="latitude" id="latitude" class="form-control" placeholder="Latitude" value="{{ old('latitude', $farm->latitude) }}">
                </div>
                <div class="col-6">
                    <input type="number" step="0.00000001" name="longitude" id="longitude" class="form-control" placeholder="Longitude" value="{{ old('longitude', $farm->longitude) }}">
                </div>
            </div>
            <div class="mt-2">
