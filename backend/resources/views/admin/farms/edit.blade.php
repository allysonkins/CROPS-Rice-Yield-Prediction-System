...
<form id="farmForm" action="{{ route('admin.farms.update', $farm->id) }}" method="POST">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <div class="row g-2">
                <div class="col-6">
                    <input type="number" step="0.00000001" name="latitude" class="form-control" placeholder="Latitude" value="{{ old('latitude', $farm->latitude) }}">
                </div>
                <div class="col-6">
                    <input type="number" step="0.00000001" name="longitude" class="form-control" placeholder="Longitude" value="{{ old('longitude', $farm->longitude) }}">
                </div>
            </div>
