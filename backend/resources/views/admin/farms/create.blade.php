...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0"><i class="bi bi-plus-circle"></i> Add Farm</h4>
    ...
    <form action="{{ route('admin.farms.store') }}" method="POST">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="e.g., Dela Cruz Rice Field" value="{{ old('name') }}" required>
                @error('name')
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="barangay" class="form-control @error('barangay') is-invalid @enderror" placeholder="e.g., Calaocan" value="{{ old('barangay') }}" required>
                @error('barangay')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="number" step="0.01" name="land_area_ha" class="form-control @error('land_area_ha') is-invalid @enderror" placeholder="2.50" value="{{ old('land_area_ha') }}" required>
                @error('land_area_ha')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="row g-2">
                    <div class="col-6">
                        <input type="number" step="0.00000001" name="latitude" class="form-control @error('latitude') is-invalid @enderror" placeholder="Latitude" value="{{ old('latitude') }}">
                    </div>
                    <div class="col-6">
                        <input type="number" step="0.00000001" name="longitude" class="form-control @error('longitude') is-invalid @enderror" placeholder="Longitude" value="{{ old('longitude') }}">
                    </div>
                </div>
